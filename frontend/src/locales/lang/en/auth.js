export default {
  ...
  // Register page
  registerTitle: 'Register ZX Testing Platform',
  registerSubtitle: 'Create your ZX Testing Platform account',
  username: 'Username',
  email: 'Email',
  ...
  // Copyright
  copyright: '© 2024 ZX Testing Platform. All rights reserved.',
